...
Take Appium Screenshot at Test Level
    Capture page screenshot    ${OUTPUTDIR}${/}${avar('screenshot_dir')}${/}${TEST NAME}_${screenshotCount}.png

Take Appium Screenshot at Suite Level
    Capture page screenshot    ${OUTPUTDIR}${/}${avar('screenshot_dir')}${/}${SUITE NAME}_${screenshotCount}.png
